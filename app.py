...
with st.sidebar:
    ...
    if st.button("Sign Out", use_container_width=True, key="unique_signout_btn"):
        st.session_state.clear()
        st.rerun()
...
try:
    current_params = str(st.query_params)
    if "google8f839dd0ed251415" in current_params:
        st.write("google-site-verification: google8f839dd0ed251415.html")
        st.stop()
except Exception:
    pass
